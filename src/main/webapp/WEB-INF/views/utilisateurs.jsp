...
<body>
   ...
   <!-- Toast de succès -->
    ...
    <c:if test="${not empty errorMessage}">
        <div id="error-toast" class="toast show position-fixed top-0 end-0 m-3 mt-5" role="alert">
            ...
            <div class="toast-body">
                ${errorMessage}
                <div class="progress mt-2">
                    <div class="progress-bar progress-bar-striped progress-bar-animated bg-danger" style="width: 100%; transition: width 5s;"></div>
                </div>
            </div>
        </div>
    </c:if>
    <!-- Script pour cacher les toasts après 5s -->
    <script>
        setTimeout(() => {
            let successToast = document.getElementById('message-toast');
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item px-2"><a class="nav-link active" href="/utilisateurs"><i class="fas fa-users"></i> Utilisateurs</a></li>
    ...
    <div class="container main-content">
        <h2 class="text-center"><i class="fas fa-users"></i> Gestion des Utilisateurs</h2>
